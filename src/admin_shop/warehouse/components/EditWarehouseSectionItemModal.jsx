...
const AddProductModal = ({ product }) => {
  ...
  console.log("abcdef-products", product);
  ...
  return (
    <Fragment>
      ...
      <button
        ...
        data-toggle="modal"
        data-target={`#addOrder` + product.warehouse_item_id}
      >
        Edit
      </button>

      {/* <!-- The Modal --> */}
      <div class="modal" id={"addOrder" + product.warehouse_item_id}>
        <div class="modal-dialog">
          <div class="modal-content">
            {/* <!-- Modal Header --> */}
            <div class="modal-header">
              <h4 class="modal-title">Edit Warehouse Section Item</h4>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                      ...
                      <select
                        ...
                        name="warehouse_section_id"
                        // value={inputs.warehouse_section_id}
                        defaultValue={product.warehouse_section_id}
                        onChange={handleChange}
                      >
                        <option value={0}>Select Warehouse Section</option>
